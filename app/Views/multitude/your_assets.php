	<div class="row">
		<div class="col-12 lead mb-4">
			<p>Just the way you want them.</p>
		</div>
	</div>
	<div class="row">
		...
		<div class="lead fw-normal col-6">
			<p>Maintain It Pro offers a cutting-edge solution for customizable asset management, empowering you to oversee and optimize your assets with unparalleled precision and ease. Whether you’re managing equipment, facilities, or digital resources, Maintain It Pro provides the tools and flexibility to tailor asset management to your specific needs. By centralizing asset information and allowing extensive customization, you can ensure that every asset is tracked, maintained, and utilized effectively.</p>
			<p>The strength of Maintain It Pro lies in its ability to adapt to your unique asset management requirements. Create custom categories, tags, and attributes to organize assets in a way that makes the most sense for your operations. With detailed asset profiles, you can store all relevant information, including purchase dates, maintenance schedules, warranty details, and usage history. This level of customization ensures that you have a comprehensive understanding of each asset, enabling informed decision-making and strategic planning.</p>
		</div>
	</div>
