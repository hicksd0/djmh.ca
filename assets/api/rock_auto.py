...
def get_years( search_make, search_link ):
	years_list = []
...
@rockauto_api.get("/years/{search_vehicle}")
def get_models( search_make, search_year, search_link ):
	models_list = []
...
def get_engines( search_make, search_year, search_model, search_link ):
	engines_list = []
...
def get_categories( search_make, search_year, search_model, search_engine, search_link ):
	categories_list = []
	...
	for x in soup:
		categories_list.append( {'make': search_make, 'year': search_year, 'model': search_model, 'engine': search_engine, 'category': x.get_text(), 'link': 'https://www.rockauto.com' + str( 
x.get('href') ) })

	return categories_list

@rockauto_api.get("/sub_categories/{search_vehicle}")
def get_sub_categories( search_make, search_year, search_model, search_engine, search_category, search_link ):
	sub_categories_list = []
	...
	for x in soup:
		sub_categories_list.append( {'make': search_make, 'year': search_year, 'model': search_model, 'engine': search_engine, 'category': search_category, 'sub_category': x.get_text(), 'link': 
'https://www.rockauto.com' + str( x.get('href') ) })
